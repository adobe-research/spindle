...
\title[Spindle, CloudCom 2014]{
  {\LARGE Spindle - CloudCom 2014}\\
  {\small Performance study of Spindle, a web analytics\\[-3mm]
...
\begin{table}[ht]
  ...
  &
    Q0 &  Q1  &  Q2  &  Q3  &  Q4  &  Q5  &  Q6  &  Q7  \\ \hline \pause
  post\_pagename &
   \mt &      &      &      &  \mt &  \mt &  \mt &      \\ \pause
  user\_agent &
       &      &      &      &      &  \mt &      &      \\ \pause
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  ...
  \pause
  \begin{center}
    \includegraphics[width=0.9\textwidth]{adhoc1.png}
  \end{center}
}
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  \begin{itemize}
    \item Spark SQL processes relational queries.
  \end{itemize}
  \begin{center}\includegraphics[width=0.9\textwidth]{adhoc2.png}\end{center}
}
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  \begin{itemize}
    \item Spark SQL processes relational queries.
  \end{itemize}
  \begin{center}\includegraphics[width=0.9\textwidth]{adhoc3.png}\end{center}
}
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  \begin{itemize}
    \item Spark SQL processes relational queries.
  \end{itemize}
  \begin{center}\includegraphics[width=0.9\textwidth]{adhoc4.png}\end{center}
}
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  \begin{itemize}
    \item<+-> Six cluster nodes, Spark and HDFS on each.
    \item<+-> 13.1GB of data.
    \item<+-> {\bf Question:} How much better performance does caching give?
  \end{itemize}
}
...
\begin{figure}[ht]
  \centering
  Loading data takes around ten seconds. \\
  \pause
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  ...
  \begin{tikzpicture}
    \draw[squig] (0,0.5) -- (0.5,0.5);\node at (0.5,0.7)
      {{\footnotesize $t_1^1$}}; \pause
    \draw[squig] (0,0) -- (2,0);\node at (2,0.2) {{\footnotesize $t_1^2$}}; \pause

    \draw[squig] (0.7,0.5) -- (1.5,0.5);\node at (1.5,0.7)
      {{\footnotesize $t_2^1$}}; \pause
    \draw[squig] (1.7,0.5) -- (2.5,0.5);\node at (2.5,0.7)
      {{\footnotesize $t_3^1$}}; \pause

    \draw[squig] (2.2,0) -- (3,0);\node at (3,0.2) {{\footnotesize $t_2^2$}}; \pause

    \draw[squig] (2.7,0.5) -- (4.0,0.5);\node at (3.7,0.7)
      {{\footnotesize \sout{$t_4^1$}}}; \pause

    \draw[squig] (3.2,0) -- (4,0);\node at (4,0.2) {{\footnotesize $t_3^2$}}; \pause
    \draw (4,-0.5) -- (4,1);
  \end{tikzpicture}
  }
  \end{center}
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  The Spark scheduler efficiently executes concurrent queries.
  \pause
  \bigskip
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  \begin{itemize}
    \item<+-> Spark is a good candidate for real-time analytics processing.
      ...
      \end{itemize}
    \item<+-> {\bf Spindle} is a prototype benchmarkable analytics engine.
    \item<+-> Spindle's future work is on data format and preprocessing.
  \end{itemize}
  \vspace{4mm}
  \begin{center}
    {\scriptsize
