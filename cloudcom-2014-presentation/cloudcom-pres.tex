...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  \begin{itemize}
  \item Demo: \url{http://adobe-research.github.io/spindle/}
  \end{itemize}
}
...
\frame{
  ...
  \begin{tikzpicture}[every node/.style={anchor=south west}]
    ...
    \fill[white] (0,0) rectangle (10,7.45) {};
    \pause
    \node at (0,0)(){\includegraphics[width=1\textwidth]{results-2014.08.02/caching/caching.pdf}};
    \fill[white] (1.4,0.95) rectangle (10,7.45) {};
    \pause
    \node at (0,0)(){\includegraphics[width=1\textwidth]{results-2014.08.02/caching/caching.pdf}};
...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  \begin{itemize}
    ...
    \item<+-> Concurrently call a single query on the same data.
    \item<+-> Average the execution time.
...
\newcommand{\revealConcurrent}[1]{
  \frame{
    \begin{tikzpicture}[every node/.style={anchor=south west}]
      ...
      \pause
      \node at (0,0)(){\includegraphics[width=\textwidth]{#1}};
      \fill[white] (1.5,0.95) rectangle (10,7.45) {};
      \pause
      \node at (0,0)(){\includegraphics[width=\textwidth]{#1}};
