...
\frame{\frametitle{\insertsection}\framesubtitle{\insertsubsection}
  ...
  \begin{center}
    \begin{tikzpicture}
      \node at (0,0) {\includegraphics[width=0.9\textwidth]{adhoc1.png}};
      \pause
      \node at (0,0) {\includegraphics[width=0.9\textwidth]{adhoc2.png}};
      \pause
      \node at (0,0) {\includegraphics[width=0.9\textwidth]{adhoc3.png}};
      \pause
      \node at (0,0) {\includegraphics[width=0.9\textwidth]{adhoc4.png}};
    \end{tikzpicture}
  \end{center}
}
